...
export type NauticalPresenceState = 'In Focus' | 'Adrift' | 'Last Anchored' | 'in_focus' | 'adrift' | 'last_anchored';
...
export type OAuthProvider = 'google' | 'github' | 'discord' | 'facebook' | 'spotify' | 'twitter';
